                ...
                <BlockSkeleton isDisplayed={entityStore.isLoadingSalaries}>
                    <Block
                        ...
                        <Typography
                            variant='H3'
                            variantMobile='H4'>
                            {formatMoney(entityStore.entity?.salaries?.inRegion?.minValue)} - {deviceType === 'desktop' ? '' : <br/>} {formatMoney(entityStore.entity?.salaries?.inRegion?.maxValue)} ₽
                        </Typography>
                    </Block>
                </BlockSkeleton>
                <BlockSkeleton isDisplayed={entityStore.isLoadingSalaries}>
                    <Block
                        ...
                        <Typography
                            variant='H3'
                            variantMobile='H4'>
                            {formatMoney(entityStore.entity?.salaries?.inCapital?.minValue)} - {deviceType === 'desktop' ? '' : <br/>} {formatMoney(entityStore.entity?.salaries?.inCapital?.maxValue)} ₽
                        </Typography>
                    </Block>
                </BlockSkeleton>
            </div>
