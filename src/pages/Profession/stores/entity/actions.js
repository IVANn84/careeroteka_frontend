...
export default self => ({
    ...
    fetchSkills: flow(function * () {
        ...
        const gradeId = getParent(self).fieldsStore.gradeId;
        const directionId = getParent(self).fieldsStore.directionId;
    ...
    fetchStatistic: flow(function * () {
        ...
        const {errors, data: statistic} = yield StatisticApi.FetchProfessionSalaries({gradeId, directionId});
